...
<body>
  <div class="container">
    ...
    <div id='9' class="btn btn-primary">shoot </div>
    <div id='11' class="btn btn-primary">release</div>
    </main>
      <h3 id="10" class="toggle active">Automatic</h3>
    
    <div class="text btn btn-secondary" onclick="etoggle()">Click me to change to manual</div>
